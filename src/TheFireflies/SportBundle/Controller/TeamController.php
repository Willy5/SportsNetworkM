...
use TheFireflies\SportBundle\Form\TeamType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TheFirefliesSportBundle:Team')->findAll();

        return $this->render('TheFirefliesSportBundle:Team:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
